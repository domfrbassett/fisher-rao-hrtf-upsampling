\begin{table}[!t]
\centering
\caption{Population-median Fisher-predicted local $d'=1$ angular thresholds in degrees. Coordinate pairs give $(\mathrm{azimuth},\mathrm{elevation})$. Lateral columns use horizontal-plane azimuthal displacements and vertical columns use frontal-plane elevational displacements. Err. is the mean absolute deviation from the dense reference across the five thresholds.}
