...
\begin{enumerate}
    ...
    \item \textbf{RANF:} a retrieval-augmented neural field that predicts magnitude and ITD and reconstructs HRIRs using a minimum-phase representation with ITD compensation \cite{Masuyama2026RANF,Masuyama2025ICASSPRANF}.
