...
\begin{center}
\includegraphics[width=0.62\textwidth]{figures/authors_cheshire_bassett_smith.jpg}\\[-0.2em]
{\footnotesize\itshape Left to right: Matthew Cheshire, Dominic Bassett, and Samuel Smith.}
\end{center}

\vspace{0.75em}

\noindent\textbf{Matthew Cheshire} is with Birmingham City University, Birmingham, U.K.

\vspace{0.75em}

\noindent\textbf{Dominic Bassett} is with Birmingham City University, Birmingham, U.K.

\vspace{0.75em}

\noindent\textbf{Samuel Smith} is with Birmingham City University, Birmingham, U.K.
